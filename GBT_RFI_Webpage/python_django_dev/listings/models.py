...
class MasterRfiCatalog(models.Model):
    ...
    frequency_mhz = models.DecimalField(db_column='Frequency_MHz', max_digits=12, decimal_places=6, blank=True, null=True)  # Field name made lowercase.
...
class CleanDev(models.Model):
    data_ID = models.IntegerField(primary_key=True)
    feed = models.IntegerField(blank=True, null=True)
    frontend = models.CharField(max_length=15, blank=True, null=True)
    azimuth_deg = models.DecimalField(db_column='azimuth_deg', max_digits=8, decimal_places=5, blank=True, null=True)  # Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    projid = models.CharField(max_length=50, blank=True, null=True)
    resolution_mhz = models.DecimalField(db_column='resolution_mhz', max_digits=11, decimal_places=10, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    window = models.IntegerField(db_column='Window', blank=True, null=True)  # Field name made lowercase.
    exposure = models.DecimalField(max_digits=8, decimal_places=5, blank=True, null=True)
    utc_hrs = models.DecimalField(max_digits=8, decimal_places=6, blank=True, null=True)
    ...
    intensity_jy = models.DecimalField(db_column='Intensity_Jy', max_digits=15, decimal_places=6, blank=True, null=True)  # Field name made lowercase.
    scan_number = models.IntegerField(blank=True, null=True)
    elevation_deg = models.DecimalField(db_column='elevation_deg', max_digits=8, decimal_places=6, blank=True, null=True)  # Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    def __str__(self):
        return self.filename
